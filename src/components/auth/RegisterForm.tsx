    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="relative w-full max-w-sm overflow-hidden rounded-xl border bg-background px-8 py-8 shadow-lg">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Google Button */}
          <Button onClick={signIn} variant="outline" className="mt-6 w-full gap-3">
            <GoogleLogo />
...
const GoogleLogo = () => (
  <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
    <path
      fill="#4285F4"
      d="M15.6 8.2c0-.5 0-1-.1-1.6H8v3.1h4.3c-.2 1-.8 1.9-1.6 2.4v2h2.6c1.5-1.4 2.3-3.4 2.3-5.9z"
    />
    <path
      fill="#34A853"
      d="M8 16c2.2 0 4-.7 5.3-2l-2.6-2c-.7.5-1.6.8-2.7.8-2 0-3.7-1.4-4.3-3.3H1.1v2.1C2.5 14.3 5.1 16 8 16z"
    />
    <path fill="#FBBC04" d="M3.7 9.5c-.3-1-.3-2.1 0-3.1V4.3H1.1C0 6.6 0 9.3 1.1 11.6l2.6-2.1z" />
    <path
      fill="#EA4335"
      d="M8 3.2c1.2 0 2.3.4 3.2 1.2l2.3-2.2C12 1 10.1.3 8 .3 5.1.3 2.5 2 1.1 4.3l2.6 2.1C4.3 4.6 6 3.2 8 3.2z"
    />
  </svg>
);
